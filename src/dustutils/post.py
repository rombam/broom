...
class Probe(PrintAnalysis):
    ...
    variable : str, list
        Variable(s) to be visualized.
    input_type : str
        The way probing points are specified. Can be 'point_list' for a series of points
        specified directly in the input file or 'from_file' to load the list of points
        from a formatted ascii file.
    point : ProbePoint, list(ProbePoint), optional
        Probe point(s) to be used. Required if input_type is 'point_list'.
    file : str, Path, optional
        Path to the file containing the list of points. Required if input_type is 'from_
        file'.
    step_res : int, optional
        Step between results to be visualized. Default is 1.
    format : str, optional
